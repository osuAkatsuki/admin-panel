...
{
    public const UserBanned = -2; // user is banned, show warning
    public const Thieving = -1; // someone appears to be thieving. the token is deleted from db for security
    public const Failure = 0;  // cookie has been removed
    public const NowLoggedIn = 1;  // the user is now logged in successfully
}
